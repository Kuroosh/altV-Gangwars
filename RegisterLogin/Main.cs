...
namespace Gangwars.RegisterLogin
{
    public class Main : IScript
    {
        ...
        public void OnPlayerLoginTry(PlayerModel playerClass, string name, string password)
        {
            ...
            catch (Exception ex) { Core.Debug.CatchExceptions("Gangwars:Login", ex); }
        }
        ...
        public void OnPlayerRegisterTry(PlayerModel playerClass, string name, string password)
        {
            ...
            catch (Exception ex) { Core.Debug.CatchExceptions("Gangwars:Register", ex); }
        }
        ...
        public static void GiveRandomHair(PlayerModel playerClass)
        {
            ...
            catch (Exception ex) { Core.Debug.CatchExceptions("RandomHair", ex); }
        }
        ...
        public static void GivePlayerGangwarWeapons(PlayerModel player)
        {
            try
            {
                player.GivePlayerWeapon(AltV.Net.Enums.WeaponModel.DoubleActionRevolver, 9999);
                player.GivePlayerWeapon(AltV.Net.Enums.WeaponModel.HeavyRevolverMkII, 9999);
                player.GivePlayerWeapon(AltV.Net.Enums.WeaponModel.Pistol50, 9999);
                player.GivePlayerWeapon(AltV.Net.Enums.WeaponModel.MiniSMG, 9999);
                player.GivePlayerWeapon(AltV.Net.Enums.WeaponModel.SMG, 9999);
                player.GivePlayerWeapon(AltV.Net.Enums.WeaponModel.PumpShotgun, 9999);
                player.GivePlayerWeapon(AltV.Net.Enums.WeaponModel.Musket, 9999);
                player.GivePlayerWeapon(AltV.Net.Enums.WeaponModel.APPistol, 9999);
                player.GivePlayerWeapon(AltV.Net.Enums.WeaponModel.CombatPDW, 9999);
                player.GivePlayerWeapon(AltV.Net.Enums.WeaponModel.BullpupRifle, 9999);
                player.GivePlayerWeapon(AltV.Net.Enums.WeaponModel.AdvancedRifle, 9999);
                player.GivePlayerWeapon(AltV.Net.Enums.WeaponModel.GusenbergSweeper, 9999);
                player.GivePlayerWeapon(AltV.Net.Enums.WeaponModel.AssaultRifle, 9999);
                player.GivePlayerWeapon(AltV.Net.Enums.WeaponModel.SpecialCarbine, 9999);
                player.GivePlayerWeapon(AltV.Net.Enums.WeaponModel.Switchblade, 9999);
                player.GivePlayerWeapon(AltV.Net.Enums.WeaponModel.Nightstick, 9999);
                player.GivePlayerWeapon(AltV.Net.Enums.WeaponModel.Machete, 9999);
                player.GivePlayerWeapon(AltV.Net.Enums.WeaponModel.BaseballBat, 9999);
            }
            catch { }
        }
